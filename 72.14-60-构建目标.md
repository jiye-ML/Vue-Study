...
## [#](https://cli.vuejs.org/zh/guide/build-targets.html#应用)应用
...
## [#](https://cli.vuejs.org/zh/guide/build-targets.html#库)库
...
### [#](https://cli.vuejs.org/zh/guide/build-targets.html#vue-vs-js-ts-入口文件)Vue vs. JS/TS 入口文件
...
## [#](https://cli.vuejs.org/zh/guide/build-targets.html#web-components-组件)Web Components 组件
...
### [#](https://cli.vuejs.org/zh/guide/build-targets.html#注册多个-web-components-组件的包)注册多个 Web Components 组件的包
...
### [#](https://cli.vuejs.org/zh/guide/build-targets.html#异步-web-components-组件)异步 Web Components 组件
