...
## [#](https://cli.vuejs.org/zh/guide/html-and-static-assets.html#html)HTML

### [#](https://cli.vuejs.org/zh/guide/html-and-static-assets.html#index-文件)Index 文件
...
### [#](https://cli.vuejs.org/zh/guide/html-and-static-assets.html#插值)插值
...
### [#](https://cli.vuejs.org/zh/guide/html-and-static-assets.html#preload)Preload

[`Preloading_content`](https://developer.mozilla.org/zh-CN/docs/Web/HTML/Preloading_content) 是一种 resource hint，用来指定页面加载后很快会被用到的资源，所以在页面加载的过程中，我们希望在浏览器开始主体渲染之前尽早 preload。
...
### [#](https://cli.vuejs.org/zh/guide/html-and-static-assets.html#prefetch)Prefetch

[`Link_prefetching`](https://developer.mozilla.org/en-US/docs/Web/HTTP/Link_prefetching_FAQ) 是一种 resource hint，用来告诉浏览器在页面加载完成后，利用空闲时间提前获取用户未来可能会访问的内容。
...
### [#](https://cli.vuejs.org/zh/guide/html-and-static-assets.html#不生成-index)不生成 index
...
### [#](https://cli.vuejs.org/zh/guide/html-and-static-assets.html#构建一个多页应用)构建一个多页应用
...
## [#](https://cli.vuejs.org/zh/guide/html-and-static-assets.html#处理静态资源)处理静态资源
...
### [#](https://cli.vuejs.org/zh/guide/html-and-static-assets.html#从相对路径导入)从相对路径导入
...
### [#](https://cli.vuejs.org/zh/guide/html-and-static-assets.html#url-转换规则)URL 转换规则
...
### [#](https://cli.vuejs.org/zh/guide/html-and-static-assets.html#public-文件夹)`public` 文件夹
...
### [#](https://cli.vuejs.org/zh/guide/html-and-static-assets.html#何时使用-public-文件夹)何时使用 `public` 文件夹
