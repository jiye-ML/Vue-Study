...
## [#](https://cli.vuejs.org/zh/guide/mode-and-env.html#模式)模式
...
## [#](https://cli.vuejs.org/zh/guide/mode-and-env.html#示例：staging-模式)示例：Staging 模式
...
## [#](https://cli.vuejs.org/zh/guide/mode-and-env.html#在客户端侧代码中使用环境变量)在客户端侧代码中使用环境变量
...
## [#](https://cli.vuejs.org/zh/guide/mode-and-env.html#只在本地有效的变量)只在本地有效的变量
